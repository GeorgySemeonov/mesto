...
const checkInputValidaty = (input, errorClassTemplate, errorClass, inputTypeErrorBorder) => {
    const erorTextElement = document.querySelector( `${errorClassTemplate}${input.name}`)
    //console.log(erorTextElement);
    if(!input.validity.valid) {
        showInputEror(erorTextElement, input.validationMessage, errorClass, inputTypeErrorBorder);
...
// const setEventListeners = (formList, inputList, errorClassTemplate, errorClass, inactiveButtonClass, submitButton) => {
...
//             //console.log(evt);
//              checkInputValidaty(input, errorClassTemplate, errorClass);
//              toggleButtonState (inputList, submitButton, inactiveButtonClass);
//             });
//     });
// }

const setEventListeners = (inputList, { errorClassTemplate, errorClass, inputTypeErrorBorder, inactiveButtonClass }, submitButton) => {
    inputList.forEach((input) => {
     input.addEventListener('input', () => {
        checkInputValidaty(input, errorClassTemplate, inputTypeErrorBorder, errorClass);
...
//     // console.log(inputList);
//     setEventListeners(formList, inputList, config.errorClassTemplate, config.errorClass, config.inactiveButtonClass, submitButton  );
// }
